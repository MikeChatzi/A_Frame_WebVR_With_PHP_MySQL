		...
		init: function () 
		{
		    ...
		    el.addEventListener('click', function () 
			{
				if (el.classList.contains('reverse-button') && !reversed) 
				{
					...
					setTimeout(function () 
					{
						window.location.href = 'firstfloor.php'; // Redirect 
					}, 3500);
				}
			});
		}
	...
	<a-scene style="z-index:1">
		<a-assets>
			...
			<?php 
				...
				{
					$basePath = 'passed/'; 
					echo '<img id="canva-'.$row['id'].'" src="'.$basePath . $row['userfile'].'">';
				}
...
<a-entity geometry="primitive: box"
          ...
          class="reverse-button">
			...
			<a-entity 
					showtext
					description="Mike24: Nice to meet you <?php echo (isset($_SESSION['userzname'])) ? $_SESSION['userzname'] : ''; ?>! If you are one of the first 36 people who signed up you can find your photo on the wall next to the others! Also, you can now click on the images to zoom."
			...
			if ($roww['id'] <= 6) {
									...
									<a-entity 
										...
										<a-entity id="msg-' . $roww['id'] . '" geometry="primitive: plane; height: 0.25; width: 1.2" material="src: #merme; opacity: 0.8; side: double" 
													style="z-index: 10" visible="false"  position="0.1 -0.65 0"
													text=" ; align: center; color: black; wrapCount: 42; width: auto; letterSpacing: 1; lineHeight: 38" 
													rotation="0 90 0">
									   </a-entity>
										</a-entity>';
						...
						elseif($roww['id']<= 12)
                        {
							echo '<a-entity showtext
									...
									>
										...
										<a-entity id="msg-' . $roww['id'] . '" geometry="primitive: plane; height: 0.25; width: 1.2" material="src: #merme; opacity: 0.8; side: double" 
												 style="z-index: 10" visible="false" position="0.1 -0.6 0" 
												 text=" ; align: center; color: black; wrapCount: 42; width: auto; letterSpacing: 1; lineHeight: 38"  
												 rotation="0 90 0">
										 </a-entity>
									</a-entity>' ;
						...
						elseif($roww['id']<= 18)
                        {
							echo '<a-entity description="' . $roww['userzname'] . ': ' . $roww['textt'] . '"
									...
									<a-entity id="msg-' . $roww['id'] . '" geometry="primitive: plane; height: 0.25; width: 1.2" material="src: #merme; opacity: 0.8; side: double" 
                                              style="z-index: 10" visible="false" position="0.1 -0.535 0" 
											  text=" ; align: center; color: black; wrapCount: 42; width: auto; letterSpacing: 1; lineHeight: 38"   
												rotation="0 90 0">
									</a-entity>
								  </a-entity> ' ;
